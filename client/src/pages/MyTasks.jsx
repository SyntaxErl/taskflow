...
const getStatusLabel = (status) =>
  ({ todo: "Todo", in_progress: "In Progress", done: "Done" })[status] ||
  status;
...
export default function MyTasks() {
  ...
  const [sort, setSort] = useState("due_latest");
  ...
  const calcPopoverPos = (btnRef, popoverWidth) => {
    ...
    const left =
      spaceRight < popoverWidth ? rect.right - popoverWidth : rect.left;
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  style={{
                    color: isCurrent ? p.color : "#374151",
                ...
                {isCurrent && (
                  <span
                    className="material-icons"
                    style={{ fontSize: "14px", color: p.color }}
                  >
                    check
                  </span>
                )}
  ...
  const Pagination = ({ compact = false }) => (
    <div
      className={`flex flex-wrap items-center justify-between gap-3 px-5 py-3 ${compact ? "" : "border-t border-gray-100"}`}
    >
      <p className="text-sm text-gray-500">
        Showing {tasks.length === 0 ? 0 : (page - 1) * perPage + 1} to{" "}
        {Math.min(page * perPage, total)} of {total} tasks
      </p>
      <div className="flex items-center gap-1">
        ...
        {compact ? (
          <span
            className="w-8 h-8 rounded-lg text-sm font-medium border flex items-center justify-center"
            style={{
          ...
          <>
            {Array.from(
              ...
              <button
                ...
                style={{
                  backgroundColor: page === p ? "#5b4fcf" : "white",
                  color: page === p ? "white" : "#6b7280",
                  borderColor: page === p ? "#5b4fcf" : "#e5e7eb",
                }}
              >
                {p}
              </button>
        ...
        {!compact && (
          <select
            className="ml-2 border border-gray-200 rounded-lg px-2 py-1.5 text-sm text-gray-600 bg-white outline-none"
            disabled
          >
  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif" }}>
      <div className="max-w-7xl mx-auto w-full space-y-4 px-1 sm:px-6 py-4">
        {/* ── Toolbar ── */}
        {(() => {
          const activeFilterCount = [status, priority, category].filter(
            Boolean,
          ).length;
          const SORT_OPTIONS = [
            {
          ...
          return (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3">
              <div className="flex items-center gap-2 flex-wrap">
                {/* Search */}
                <div
                  className="flex items-center gap-2 border border-gray-200 rounded-xl px-3 py-2 bg-gray-50/50 flex-1 min-w-[180px]"
                ...
                <div className="relative" ref={filterRef}>
                  <button
                    ...
                    onClick={() => {
                      if (!filterOpen)
                        setFilterPos(calcPopoverPos(filterBtnRef, 320));
                      setFilterOpen((p) => !p);
                      setSortOpen(false);
                    }}
                    ...
                    style={{
                      borderColor:
                        activeFilterCount > 0 ? "#5b4fcf" : "#e5e7eb",
                      backgroundColor:
                        activeFilterCount > 0 ? "#f5f3ff" : "white",
                ...
                <div className="relative" ref={sortRef}>
                  <button
                    ...
                    onClick={() => {
                      if (!sortOpen)
                        setSortPos(calcPopoverPos(sortBtnRef, 256));
                      setSortOpen((p) => !p);
                      setFilterOpen(false);
                    }}
                  ...
                  >
                    <span
                      className="material-icons"
                      style={{ fontSize: "16px", color: "#5b4fcf" }}
                    >
                      swap_vert
                    </span>
                        ...
                        {SORT_OPTIONS.map((o) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {isActive && (
                                <span
                                  className="material-icons ml-auto flex-shrink-0"
                                  style={{ fontSize: "16px", color: "#5b4fcf" }}
                                >
                                  check
                                </span>
                    ...
                    {priority && (
                      <span
                        ...
                        style={{
                          ...
                          borderColor: getPriorityColor(priority).dot + "60",
                        }}
                      >
                    ...
                    {category && (
                      <span
                        ...
                        style={{
                          ...
                          borderColor: getCategoryColor(category).text + "40",
                        }}
                      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {loading ? (
              <div className="col-span-full flex items-center justify-center py-16 bg-white rounded-2xl border border-gray-100">
                <span
                  className="material-icons animate-spin text-purple-400"
                  style={{ fontSize: "32px" }}
                >
                  autorenew
                </span>
              ...
              <div className="col-span-full flex flex-col items-center justify-center py-16 bg-white rounded-2xl border border-gray-100 text-center">
                <span
                  className="material-icons text-gray-200 mb-3"
                  style={{ fontSize: "48px" }}
                >
                  assignment
                </span>
        ...
        <div className="hidden min-[1400px]:block bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div>
            ...
            <div
              ...
              style={{
                gridTemplateColumns:
                  "40px minmax(200px,1fr) 120px 120px 160px 130px 110px 40px",
              }}
            >
              <div>
                <input
              ...
              <div
                ...
                onClick={() =>
                  setSort(
                    sort === "due_earliest" ? "due_latest" : "due_earliest",
                  )
                }
              >
                Due Date
                <span
                  ...
                  style={{
                    fontSize: "14px",
                    color:
                      sort === "due_earliest" || sort === "due_latest"
                        ? "#5b4fcf"
                        : "#9ca3af",
                  }}
                >
