          ...
          {[
            {
              ...
              desc: "Manage tasks and projects in one place.",
            },
            {
              icon: "groups",
              label: "Collaborate",
            ...
            },
            {
              ...
              desc: "Monitor progress and hit your goals.",
            },
          ].map((item) => (
            <div key={item.label} className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-purple-200">
                <span
                  ...
                  style={{ fontSize: "20px", color: "#5b4fcf" }}
                >
                  {item.icon}
                </span>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center border border-gray-300 rounded-xl px-3.5 py-3 bg-gray-50 focus-within:border-purple-400 focus-within:bg-white transition-all">
                <span
                  className="material-icons text-gray-400 mr-2"
                  style={{ fontSize: "20px" }}
                >
                  person
                </span>
                  ...
                  <div className="flex gap-1.5">
                    {["25%", "50%", "75%", "100%"].map((w, i) => (
                      <div
                        ...
                        style={{
                          background:
                            parseFloat(strength.width) >= parseFloat(w)
                              ? strength.color
                              : "#e5e7eb",
                        }}
                      />
